...
function App() {
  ...
  return (
    <>
      <header>
        <div className="container">
            ...
            <button className="nav-toggle"><i className="fas fa-bars"></i></button>
            <nav>
    ...
    <main>
        <img src="/pics/landing-image-1.jpg" 
        ...
        <div className="hero-text">
            ...
            <p>STUDENT</p>
            <a href=".." download="My_CV.pdf"><button>Download Resume</button></a>
    ...
    <section id="portfolio">
        <div className="container">
            ...
            <div className="portfolio-grid">
                <div>
                    <img alt="Interior design of a modern living room" src="/pics/gallery-image-1.jpg"/>
                </div>
                <div>
                    <img alt="Modern architectural building" src="/pics/gallery-image-2.jpg"/>
                </div>
                <div className="tall">
                    <img alt="Modern high-rise building" src="/pics/gallery-image-3.jpg"/>
                </div>
                <div>
                    <img alt="Dining area with a round table" src="/pics/gallery-image-4.jpg"/>
                </div>
                <div>
                    <img alt="Set of modern white ceramic containers" src="/pics/gallery-image-5.jpg"/>
                </div>
            </div>
        </div>
    </section>
